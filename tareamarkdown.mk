...
If you are processing paired-end reads, then you will get four files per barcode, two for the single-end read and two for the *paired-end reads*. For example, given barcode ACTCG, you would see the following four files: 
...
There is additional information available in <span style="color:green">**process_radtags** </span> <span style="color:blue">manual page </span>. 
